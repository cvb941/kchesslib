...
class MoveListTest {
    ...
    fun testMoveListStartingPosition() {
        val san = arrayOf("e4", "e4 e6", "e4 e6 f4")
        val fen = arrayOf(
    ...
    fun testMoveList() {
        val s =
            "e2e4 b8c6 d2d4 g8f6 d4d5 c6e5 g1f3 d7d6 f3e5 d6e5 f1b5 c8d7 b5d7 d8d7 b1c3 e7e6 e1g1 e6d5"
        val san = "e4 Nc6 d4 Nf6 d5 Ne5 Nf3 d6 Nxe5 dxe5 Bb5+ Bd7 Bxd7+ Qxd7 Nc3 e6 O-O exd5 "
        val list = MoveList()
        list.loadFromText(s)
        val mvs = s.split(" ")
    ...
    @Test
    @Throws(MoveConversionException::class)
    fun testMoveListPGN1() {
        val moveText = "1.d4 d5 2.c4 c6 3.Nf3 Nf6 4.e3 Bf5 5.Nc3 e6 6.Nh4 Bg6 7.Nxg6 " +
    ...
    @Test
    @Throws(MoveConversionException::class)
    fun testMoveListPGN2() {
        val moveText = "1.e4 c5 2.Nf3 d6 3.d4 cxd4 4.Nxd4 Nf6 5.Nc3 a6 6.Bc4 Nbd7 7.O-O " +
    ...
    @Test
    @Throws(MoveConversionException::class)
    fun testMoveListPGN3() {
        val moveText = "1.Nf3 d6 2.d4 Bg4 3.c4 Nd7 4.e4 Bxf3 5.Qxf3 g6 6.Nc3 Bg7 7.Qd1 " +
    ...
    @Test
    fun testSanCastleWithMate() {
        val san = ("1. d4 e6 2. Nf3 f5 3. Nc3 Nf6 4. Bg5 Be7 5. Bxf6 Bxf6 6. e4 fxe4 7. Nxe4 b6 "
