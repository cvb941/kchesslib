...
class PgnHolderTest {
    ...
    fun testPGNLoad1() {
        val pgn = PgnHolder("src/test/resources/cct131.pgn")
        pgn.loadPgn()
    ...
    @Throws(Exception::class)
    fun testPGNLoad2() {
        val pgn = PgnHolder("src/test/resources/rav_alternative.pgn")
        pgn.loadPgn()
        val game = pgn.getGames()[0]
        game.loadMoveText()
    ...
    @Throws(Exception::class)
    fun testPGNLoad3() {
        val pgn = PgnHolder("src/test/resources/linares_2002.pgn")
        pgn.loadPgn()
    ...
    @Throws(Exception::class)
    fun testPGNLoad4() {
        val pgn = PgnHolder("src/test/resources/redqueen.pgn")
        pgn.loadPgn()
        val game = pgn.getGames()[1]
        game.loadMoveText()
    ...
    fun testPromotionWithMissingEqualSign() {
        val pgn = PgnHolder("src/test/resources/promoting.pgn")
        pgn.loadPgn()
        val game = pgn.getGames()[0]
        game.loadMoveText()
    ...
    @Throws(Exception::class)
    fun testCupPgn() {
        val pgn = PgnHolder("src/test/resources/cup.pgn")
        pgn.loadPgn()
    ...
    @Throws(Exception::class)
    fun testOO() {
        val pgn = PgnHolder("src/test/resources/oo.pgn")
        pgn.loadPgn()
        for (game in pgn.getGames()) {
            game.loadMoveText()
            val moves = game.halfMoves
    ...
    @Throws(Exception::class)
    fun testEP() {
        val pgn = PgnHolder("src/test/resources/ep.pgn")
        pgn.loadPgn()
        for (game in pgn.getGames()) {
            game.loadMoveText()
            val moves = game.halfMoves
    ...
    @Throws(Exception::class)
    fun testZ0() {
        val pgn = PgnHolder("src/test/resources/z0.pgn")
        pgn.loadPgn()
        for (game in pgn.getGames()) {
            game.loadMoveText()
            val moves = game.halfMoves
    ...
    @Throws(Exception::class)
    fun testErr() {
        val pgn = PgnHolder("src/test/resources/err.pgn")
        pgn.loadPgn()
        for (game in pgn.getGames()) {
            game.loadMoveText()
            val moves = game.halfMoves
    ...
    @Throws(Exception::class)
    fun testAnsi() {
        val pgn = PgnHolder("src/test/resources/Morphy_ANSI.pgn")
        pgn.loadPgn()
        for (game in pgn.getGames()) {
            game.loadMoveText()
            val moves = game.halfMoves
    ...
    @Throws(Exception::class)
    fun testUtf8() {
        val pgn = PgnHolder("src/test/resources/Morphy_UTF8.pgn")
        pgn.loadPgn()
        for (game in pgn.getGames()) {
            game.loadMoveText()
            val moves = game.halfMoves
    ...
    fun testLongMoves() {
        ...
        val pgn = PgnHolder("src/test/resources/longest.pgn")
        pgn.loadPgn()
        for (game in pgn.getGames()) {
            game.loadMoveText()
            val moves = game.halfMoves
    ...
    @Throws(Exception::class)
    fun testRepetition() {
        val pgn = PgnHolder("src/test/resources/test.pgn")
        pgn.loadPgn()
        val game = pgn.getGames()[0]
        game.loadMoveText()
    ...
    @Throws(Exception::class)
    fun testRepetition2() {
        val pgn = PgnHolder("src/test/resources/alekseenko_grachev_2017.pgn")
        pgn.loadPgn()
        val game = pgn.getGames()[0]
        game.loadMoveText()
    ...
    @Throws(Exception::class)
    fun testRepetition3() {
        val pgn = PgnHolder("src/test/resources/nikolic_arsovic_1989.pgn")
        pgn.loadPgn()
        val game = pgn.getGames()[0]
        game.loadMoveText()
    ...
    @Throws(Exception::class)
    fun testRepetition4() {
        val pgn = PgnHolder("src/test/resources/no_repetition_1.pgn")
        pgn.loadPgn()
        val game = pgn.getGames()[0]
        game.loadMoveText()
    ...
    @Throws(Exception::class)
    fun testRepetition5() {
        val pgn = PgnHolder("src/test/resources/no_repetition_2.pgn")
        pgn.loadPgn()
        val game = pgn.getGames()[0]
        game.loadMoveText()
        val keys: MutableList<String> = ArrayList()
    ...
    fun testBoardHashKeyConsistency() {
        val pgn = PgnHolder("src/test/resources/Stockfish_DD_64-bit_4CPU.pgn")
        pgn.loadPgn()
    ...
    fun testLoadFromStartPosition() {
        val pgn = PgnHolder("src/test/resources/teststartpos.pgn")
        pgn.loadPgn()
        val game = pgn.getGames()[0]
        game.loadMoveText()
    ...
    fun testPgnLoadListenerWith3Events() {
        val pgn = PgnHolder("src/test/resources/3_events.pgn")
    ...
    fun testPgnLoadListenerWith31Events() {
        val pgn = PgnHolder("src/test/resources/31_events.pgn")
    ...
    fun testCountGamesInPgnFileWith3Games() {
        val pgn = PgnHolder("src/test/resources/3_games.pgn")
    ...
    fun testCountGamesInPgnFileWith31Games() {
        val pgn = PgnHolder("src/test/resources/31_games.pgn")
